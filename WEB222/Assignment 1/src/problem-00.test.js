 ...
 *
 * These tests have been written using a testing framework called Vitest,
 ...
 * have to write the tests, only get your solution code to pass them.
 *
 ...
 */
import { greeting } from './solutions';

/**
 * Next, we use one of Vitest's functions called describe().  It allows
 ...
 * We also define a test() {...} function to contain our test.  When the Problem 0
...
describe('Problem 0 - greeting() function', function () {
   ...
   * a function.  We're using Vitest's expect() function, which let's us
   * compare an actual value (something returned by running our code) to an
   * expected value (something we define in advance in our test).
   */
